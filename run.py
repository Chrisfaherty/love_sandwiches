...
def get_sales_data():
    ...
    while True:
        ...
        print('datashould be six numbers, saparated by commas.')
...
def update_worksheet(data, worksheet):
    """
    Receives a list of integres to be inserted into a worksheet
    Update the relevent wotrksheet with the data provided
    """
